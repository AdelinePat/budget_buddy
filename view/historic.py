...
class Historic():
    def __init__(self, master, account_list, display_accounts, login_info):
        self.master = master
        self.util = UtilTool()
        ...
        self.shown_historic = str(self.login_info.get_current_account())
    ...
    def recover_accounts(self):
        ...
        for index, account in enumerate(self.list_accounts):
            historic_account = Account_view(self.list_accounts[index][0], self.login_info)
